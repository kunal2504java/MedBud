        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              MediBud AI combines cutting-edge technology with medical expertise to deliver unparalleled diagnostic assistance.
            </p>
          </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-slate-600 mb-8 max-w-xl mx-auto">
                Join thousands of medical professionals already using MediBud AI to improve accuracy and save time.
              </p>
              <Button
                asChild
                size="lg"
        ...
        <div className="bg-white dark:bg-zinc-950 transition-colors">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-600 max-w-2xl mx-auto">
                Hear from our satisfied users about how MediBud AI has transformed their diagnostic processes.
              </p>
            </div>
          </div>
        </div>
